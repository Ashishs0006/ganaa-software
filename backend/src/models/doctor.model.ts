...
// Instance Method
doctorSchema.methods.correctPassword = async function (hash: string, userPass: string) {
...
doctorSchema.methods.changedPasswordAfter = function (jwtTimestamp: number) {
...
doctorSchema.methods.createOtp = function () {
...
doctorSchema.methods.activateAccount = function () {
  this.otp = undefined;
  this.otpExpiresIn = undefined;
  this.resendOTP = undefined;
};

const Doctor = mongoose.model<IDoctor>(Collections.doctor.name, doctorSchema);
